    ...
    <>
      ...
      {selectedUser && (
        ...
        >
          ...
          {/* ⚠️ Bu dosyanın orijinalinin geri kalanı (kullanıcı kartı detayları,
              tier değiştirme, jeton yönetimi, ban butonları) indirme kanalında
              kesildi. Orijinal dosya:
              https://raw.githubusercontent.com/bayastley/Nurstusyo/main/src/components/AdminUsersTab.tsx */}
        </div>
      )}
    </>
  );
