...
import { createOrder, getOrder, grantProductToUser } from "../../server/supabase";

/**
 * ★ BİRLEŞİK PAYMENTS ROUTER — /api/payments/create | /api/payments/webhook
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (route === "create") return createHandler(req, res);
  if (route === "webhook") return webhookHandler(req, res);
