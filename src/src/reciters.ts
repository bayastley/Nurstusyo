...
export const RECITERS: Reciter[] = [
  ...
  { id: "akhdar", name: "Ibrahim el-Ahdar", path: "Ibrahim_Akhdar_64kbps", makam: "Haram", risk: "low", telifRiski: 8, riskAciklamasi: "Tahmini dusuk risk.", color: low, initial: "IA", country: "Suudi Arabistan" },
