export interface Reciter {
  ...
  full?: [string, number]; // mp3quran.net tam sure: [klasor, sunucuNo] — tek tek test edildi
}
...
export const RECITERS: Reciter[] = [
  ...
  { id: "sudais", name: "Abdurrahman es-Sudays", path: "Abdurrahmaan_As-Sudais_192kbps", makam: "Haram", risk: "low", telifRiski: 20, riskAciklamasi: "Tahmini dusuk risk; platform hak politikalari ayrica kontrol edilmelidir.", color: low, initial: "AS", country: "Suudi Arabistan", full: ["sds", 11] },
  ...
  { id: "maher", name: "Maher el-Muaiqly", path: "MaherAlMuaiqly128kbps", makam: "Haram", risk: "low", telifRiski: 15, riskAciklamasi: "Tahmini dusuk risk.", color: low, initial: "MM", country: "Suudi Arabistan", full: ["maher", 12] },
  { id: "hudhaify", name: "Ali el-Hudeyfi", path: "Hudhaify_128kbps", makam: "Haram", risk: "low", telifRiski: 10, riskAciklamasi: "Tahmini dusuk risk.", color: low, initial: "AH", country: "Suudi Arabistan", full: ["hthfi", 9] },
  ...
  { id: "qatami", name: "Nasser el-Katami", path: "Nasser_Alqatami_128kbps", makam: "Telif", risk: "low", telifRiski: 20, riskAciklamasi: "Tahmini dusuk risk.", color: low, initial: "NK", country: "Suudi Arabistan", full: ["qtm", 6] },
  { id: "dosari", name: "Yasser el-Dosari", path: "Yasser_Ad-Dussary_128kbps", makam: "Telif", risk: "low", telifRiski: 25, riskAciklamasi: "Tahmini dusuk-orta risk.", color: low, initial: "YD", country: "Suudi Arabistan", full: ["yasser", 12] },
  ...
  { id: "husary", name: "Mahmud Halil el-Husari", path: "Husary_128kbps", makam: "Telif", risk: "low", telifRiski: 5, riskAciklamasi: "Klasik kayit; tahmini cok dusuk risk.", color: classic, initial: "MH", country: "Misir", full: ["husr", 13] },
  ...
  { id: "abdulbasit", name: "Abdulbasit Abdussamed (Murattal)", path: "Abdul_Basit_Murattal_192kbps", makam: "Telif", risk: "low", telifRiski: 8, riskAciklamasi: "Klasik kayit; tahmini dusuk risk.", color: classic, initial: "AB", country: "Misir", full: ["basit", 7] },
  ...
  { id: "jibreel", name: "Muhammed Cibril", path: "Muhammad_Jibreel_128kbps", makam: "Telif", risk: "low", telifRiski: 12, riskAciklamasi: "Tahmini dusuk risk.", color: classic, initial: "MC", country: "Misir", full: ["jbrl", 8] },
  { id: "alafasy", name: "Misari Resid el-Afasi", path: "Alafasy_128kbps", makam: "Telif", risk: "mid", telifRiski: 30, riskAciklamasi: "Dijital hak takibi olabilir; tahmini orta risk.", color: mid, initial: "MA", country: "Kuveyt", full: ["afs", 8] },
