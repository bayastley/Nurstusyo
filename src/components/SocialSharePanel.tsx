        ...
        <div className="glass grid gap-5 rounded-2xl p-5 lg:grid-cols-[1fr_340px_320px]">
          <div>
            ...
            <div className="relative mt-2.5 flex flex-wrap gap-2">
              ...
              {/* YouTube — doğrudan Studio yükle paylaşım sayfasına açar */}
              {shareToYouTube && (
                <button
                  onClick={shareToYouTube}
                  className="flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-[10px] font-bold text-white hover:opacity-90"
                  style={{ background: "linear-gradient(135deg,#ff0000,#cc0000)" }}
                >
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="white"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                  YouTube'a Paylaş
                </button>
              )}
              {/* TikTok — içerik üretim sayfasına yönlendir */}
              {shareToTikTok && (
                <button
              ...
              {/* Instagram — Reels paylaşım akışını başlat */}
              {shareToInstagram && (
                <button
